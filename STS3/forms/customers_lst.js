...
function onRecordSelection(event) {
	...
	forms.customer_specs.elements.btn_Delete.enabled =  (globals.checkCustEmpty(customer_id)) && (forms.customers_rec.elements.btn_New.visible);
	forms.customer_specs.elements.btn_Edit.enabled = true;
}
