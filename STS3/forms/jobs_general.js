...
function additionalSaveFunctions(){
	...
	globals.selectedCustomerID = vCustomerNumber;
	customer_id = sts_customernum_to_name.customer_id;
...
function onDataChangeCustomerNumber(oldValue, newValue, event) {
	globals.selectedCustomerID = newValue;
	vCustomerName = sts_customernum_to_name.name;
	return true
}
